...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull EditText emailEditText,
      @NonNull Button facebookButton, @NonNull Button googleButton, @NonNull ImageView imageView,
      @NonNull LinearLayout linearLayout, @NonNull Button loginButton,
      @NonNull ConstraintLayout main, @NonNull EditText passwordEditText,
      @NonNull CheckBox rememberCheckBox, @NonNull TextView signupText, @NonNull TextView textView,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, emailEditText, facebookButton,
          googleButton, imageView, linearLayout, loginButton, main, passwordEditText,
          rememberCheckBox, signupText, textView, textView2, textView3, textView4, textView5);
    }
